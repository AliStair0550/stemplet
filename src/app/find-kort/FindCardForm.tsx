    ...
    <form action={action} className="flex w-full flex-col gap-4">
      <label className="flex flex-col gap-1.5">
        ...
        <input
          ...
          className="border border-clay bg-parchment px-4 py-3 font-[200] uppercase tracking-[0.15em] text-[0.95rem] text-ink outline-none focus:border-moss"
        />
      ...
      <SubmitButton variant="moss" size="lg" pendingText="Finder dit kort...">
        Find mit kort
      </SubmitButton>
    </form>
  );
