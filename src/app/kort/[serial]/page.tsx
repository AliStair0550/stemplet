...
export default async function WebCardPage({
  ...
  // Kortets egen QR (personalet scanner den i scan-modus / ved indloesning).
  ...
  return (
    <main className="flex min-h-screen flex-col items-center bg-parchment px-6 py-12">
      <div className="flex w-full max-w-sm flex-col items-center gap-6">
        ...
        {rewardReady ? (
          <div className="w-full rounded-xl border border-moss bg-moss/5 px-5 py-4 text-center">
            <p className="font-[300] text-[1rem] text-ink">
              Din beloenning er klar
            </p>
            <p className="mt-1 font-[200] text-[0.82rem] text-stone">
              Vis dette kort ved kassen for at indloese.
            </p>
          </div>
        ) : null}
        ...
        <p className="max-w-xs text-center text-[0.72rem] font-[200] leading-relaxed text-slate">
          Foej kortet til hjemmeskaermen, saa har du det altid ved haanden.
        </p>
      </div>
    </main>
  );
